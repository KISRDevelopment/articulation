...
class _reportState extends State<report> with AfterLayoutMixin<report> {
  bool flag = false;
  late String civilID;
                        ...
                        children: [
                          ...
                          GestureDetector(
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  Text("عرض", style: TextStyle(fontSize: 50)),
                          ...
                          GestureDetector(
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  Text("تحميل", style: TextStyle(fontSize: 50)),
                                  //Icon(Icons.lightbulb_outline, size: 50)
                          ...
                          GestureDetector(
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  Text("طباعة" , style: TextStyle(fontSize: 50),),
                                 // Icon(Icons.lightbulb_outline, size: 50)
